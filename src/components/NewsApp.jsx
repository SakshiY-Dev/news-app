...
const NewsApp = () => {
  ...
  const API_KEY = "329a90b56f6d4e6f96b354a1d37a543f";
  ...
  return (
    <div>
      <nav className="flex justify-around bg-blue-300 text-black py-4 px-4 ">
        <div className="flex gap-2 items-center">
          <img src="/public/logo.png" alt="logo" className="w-15 h-15" />
